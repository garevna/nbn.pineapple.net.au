<template>
  ...
  >
    ...
    <v-card-text class="my-12">
      <span class="small text-left" style="margin-right: 16px">Pineapple NET is now offering nbn™ plans!</span>
      <v-img src="@/assets/NBN_logo-dark-blue.svg" width="150" style="display: inline-block; vertical-align: middle;"></v-img>
    </v-card-text>
  </v-card>
</template>
